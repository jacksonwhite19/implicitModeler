...
use implicit_cad::scripting::{
    condition_aero_export_parts_for_backend, evaluate_aero_export_parts,
};
...
fn main() -> Result<(), String> {
    ...
    let mut parts = evaluate_aero_export_parts(
        &source,
        None,
        None,
        None,
    ...
    condition_aero_export_parts_for_backend(&mut parts);
    let part = parts
        .iter()
