...
use super::fasteners::{NullSdf, cyl_z, get_spec, heat_set_boss_z, heat_set_void_z, orient_along};
use crate::sdf::Sdf;
...
pub fn panel_rect(
    ...
    match retention {
        ...
        // ── Screw tabs ────────────────────────────────────────────────────────
        RetentionMechanism::ScrewTabs {
            ref screw_designation,
            tab_count,
            tab_thickness,
        } => {
        ...
        // ── Living hinge ──────────────────────────────────────────────────────
        RetentionMechanism::LivingHinge {
            hinge_thickness,
            hinge_width,
        } => {
            let panel_base = oriented_box(width, height, thickness, center, n);
            ...
            let parent_add =
                oriented_box(hinge_width, hinge_thickness * 2.0, thickness, pad_pos, n);
            ...
            AccessPanel {
                ...
                parent_add,
                parent_void: Arc::new(NullSdf),
                retention: RetentionMechanism::LivingHinge {
                    hinge_thickness,
                    hinge_width,
                },
            }
        ...
        RetentionMechanism::MagnetBoss {
            ...
            AccessPanel {
                ...
                parent_add: Arc::new(NullSdf),
                parent_void,
                retention: RetentionMechanism::MagnetBoss {
                    magnet_diameter,
                    magnet_depth,
                    count,
                },
...
mod tests {
    ...
    fn snap_fit_produces_clip_geometry() {
        ...
        assert!(
            d_clip < 5.0,
            "Clip should be near panel edge at z=4, got {}",
            d_clip
        );
    }
    ...
    fn friction_fit_panel_is_inset() {
        ...
        let ap = panel_rect(
            ...
            3.0,
            Vec3::Z,
            RetentionMechanism::FrictionFit {
    ...
    fn magnet_boss_creates_holes_on_both_sides() {
        ...
        assert!(
            d < f32::MAX / 4.0,
            "Parent magnet void should be real geometry"
        );
    }
}
