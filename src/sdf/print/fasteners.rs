...
use crate::sdf::booleans::{SmoothUnion, Subtract, Union};
...
static SCREW_SPECS: &[ScrewSpec] = &[
    ScrewSpec {
        ...
        clearance_diameter_mm: 2.4,
        head_diameter_mm: 3.8,
        head_height_mm: 2.0,
        countersink_angle_deg: 90.0,
        heat_set_diameter_mm: 3.2,
        heat_set_depth_mm: 4.0,
        min_boss_diameter_mm: 5.0,
        min_wall_thickness_mm: 1.6,
    },
    ScrewSpec {
        designation: "M2.5",
        thread_diameter_mm: 2.5,
        clearance_diameter_mm: 2.9,
        head_diameter_mm: 4.5,
        head_height_mm: 2.5,
        countersink_angle_deg: 90.0,
        heat_set_diameter_mm: 3.8,
        heat_set_depth_mm: 5.0,
        min_boss_diameter_mm: 6.0,
    ...
    ScrewSpec {
        ...
        head_height_mm: 3.0,
        countersink_angle_deg: 90.0,
        heat_set_diameter_mm: 4.5,
        heat_set_depth_mm: 6.0,
        min_boss_diameter_mm: 7.0,
        min_wall_thickness_mm: 2.4,
    },
    ScrewSpec {
        designation: "M4",
        thread_diameter_mm: 4.0,
        clearance_diameter_mm: 4.5,
        head_diameter_mm: 7.0,
        head_height_mm: 4.0,
        countersink_angle_deg: 90.0,
        heat_set_diameter_mm: 5.6,
        heat_set_depth_mm: 8.0,
        min_boss_diameter_mm: 9.0,
        min_wall_thickness_mm: 3.2,
    },
    ScrewSpec {
        designation: "M5",
        thread_diameter_mm: 5.0,
        clearance_diameter_mm: 5.5,
        head_diameter_mm: 8.5,
        head_height_mm: 5.0,
        countersink_angle_deg: 90.0,
        heat_set_diameter_mm: 6.4,
        heat_set_depth_mm: 10.0,
        min_boss_diameter_mm: 10.0,
