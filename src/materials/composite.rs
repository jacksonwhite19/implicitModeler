...
pub fn preset_library() -> Vec<CompositeMaterial> {
    vec![
        CompositeMaterial {
            ...
            material_type: CompositeMaterialType::CarbonFiberUD {
        ...
        CompositeMaterial {
            ...
            material_type: CompositeMaterialType::CarbonFiberWoven {
                ply_thickness_mm: 0.20,
            },
            density_g_cm3: 1.55,
        ...
        CompositeMaterial {
            ...
            material_type: CompositeMaterialType::Fiberglass {
                ply_thickness_mm: 0.22,
            },
            density_g_cm3: 1.80,
